...
namespace Kharazmi.AspNetMvc.Core.Managers.UrlManager
{
    ...
    /// </summary>
    public class QueryProvider : List<QueryParameter>
    {
        /// <summary>
        ...
        /// <summary>
        ///     Replaces an existing QueryParameter or appends one to the end. If object is a collection type (array, IEnumerable,
        ///     etc.),
        ///     multiple parameters are added, i.e. x=1&amp;x=2. If any of the same name already exist, they are overwritten one by
        ///     one
