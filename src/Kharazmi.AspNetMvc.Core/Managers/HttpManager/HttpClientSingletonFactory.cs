...
using Kharazmi.AspNetMvc.Core.Managers.InstanceManager;

namespace Kharazmi.AspNetMvc.Core.Managers.HttpManager
{
    public class HttpClientSingletonFactory : Singleton<HttpClientSingletonFactory>, IHttpClientFactory
    {
        ...
        public HttpClientSingletonFactory()
        {
        ...
        public HttpClient GetOrCreate(string baseAddress, IDictionary<string, string> defaultRequestHeaders = null,
            TimeSpan? timeout = null, long? maxResponseContentBufferSize = null
