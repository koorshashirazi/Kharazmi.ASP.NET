    ...
    public partial class StateMachine<TState, TTrigger>
    {
        ...
        public class StateConfiguration
        {
            ...
            internal StateConfiguration(StateMachine<TState, TTrigger> machine, StateRepresentation representation
                , Func<TState, StateRepresentation> lookup)
            {
            ...
            /// <param name="internalAction">The action performed by the internal transition</param>
            /// <returns></returns>
            public StateConfiguration InternalTransition<TArg0>(TriggerWithParameters<TArg0> trigger
                , Action<TArg0, Transition> internalAction)
            {
                ...
                _representation.AddInternalAction(trigger.Trigger,
                    (t, args) => internalAction(ParameterConversion.Unpack<TArg0>(args, 0), t));
                return this;
            }
            ...
            public StateConfiguration OnDeactivate(Action deactivateAction, string deactivateActionDescription = null)
            {
                ...
                _representation.AddDeactivateAction(deactivateAction,
            ...
            public StateConfiguration OnEntry(Action entryAction, string entryActionDescription = null)
            {
                ...
                return OnEntry(t => entryAction(), entryActionDescription ?? entryAction.TryGetMethodName());
            }
                ...
                , string entryActionDescription = null)
            {
                ...
                _representation.AddEntryAction(trigger.Trigger,
                    (t, args) => entryAction(ParameterConversion.Unpack<TArg0>(args, 0), t),
                    entryActionDescription ?? entryAction.TryGetMethodName());
                return this;
            }
                ...
                , string entryActionDescription = null)
            {
                ...
                Enforce.ArgumentNotNull(trigger, nameof(trigger));
                _representation.AddEntryAction(trigger.Trigger,
                    (t, args) => entryAction(ParameterConversion.Unpack<TArg0>(args, 0),
            ...
            public StateConfiguration OnEntryFrom<TArg0, TArg1, TArg2>(
                TriggerWithParameters<TArg0, TArg1, TArg2> trigger
                , Action<TArg0, TArg1, TArg2, Transition>
                    entryAction
                , string entryActionDescription = null)
            {
                Enforce.ArgumentNotNull(entryAction, nameof(entryAction));
            ...
            public StateConfiguration OnExit(Action exitAction, string exitActionDescription = null)
            {
                ...
                return OnExit(t => exitAction(), exitActionDescription ?? exitAction.TryGetMethodName());
            }
            ...
            {
                Enforce.ArgumentNotNull(exitAction, nameof(exitAction));
                _representation.AddExitAction(exitAction, exitActionDescription ?? exitAction.TryGetMethodName());
                return this;
            }
                ...
                , Func<bool> guard, string guardDescription = null)
            {
                ...
                return InternalPermitDynamicIf(trigger.Trigger,
                    args => destinationStateSelector(ParameterConversion.Unpack<TArg0>(args, 0)), guard,
                    guardDescription ?? guard?.TryGetMethodName());
            }
                ...
                , Func<bool> guard, string guardDescription = null)
            {
                ...
                Enforce.ArgumentNotNull(destinationStateSelector, nameof(destinationStateSelector));
                return InternalPermitDynamicIf(trigger.Trigger,
                    args => destinationStateSelector(ParameterConversion.Unpack<TArg0>(args, 0),
                        ParameterConversion.Unpack<TArg1>(args, 1)), guard,
                    guardDescription ?? guard?.TryGetMethodName());
            }
                ...
                , string guardDescription = null)
            {
                ...
                return InternalPermitDynamicIf(trigger.Trigger,
                    args => destinationStateSelector(ParameterConversion.Unpack<TArg0>(args, 0),
                        ParameterConversion.Unpack<TArg1>(args, 1), ParameterConversion.Unpack<TArg2>(args, 2)), guard,
                    guardDescription ?? guard?.TryGetMethodName());
            }
                ...
                , string guardDescription)
            {
                ...
                _representation.AddTriggerBehaviour(
                    new TransitioningTriggerBehaviour(trigger, destinationState, guard, guardDescription));
                return this;
            }
