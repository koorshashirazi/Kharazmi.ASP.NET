...
namespace Kharazmi.AspNetMvc.Core.Managers.ResultManager
{
    ...
    public struct Result : IResult, ISerializable
    {
        ...
        private Result(SerializationInfo info, StreamingContext context)
        {
            ...
            var error = isFailure ? info.GetString("Error") : null;
        ...
        {
            return predicate() ? Ok<T, E>(value) : Fail<T, E>(error);
        }
        ...
        public static Result Combine(string errorMessagesSeparator, params Result[] results)
        {
            ...
            if (failedResults.Count == 0) return Ok();
    ...
    public struct Result<T> : IResult, ISerializable
    {
        ...
        public T Value
        {
            ...
            get
            {
                if (!IsSuccess) throw new ResultFailureException(Error);
    ...
    public struct Result<T, E> : IResult, ISerializable
    {
        ...
        public T Value
        {
            ...
            get
            {
                if (!IsSuccess) throw new ResultFailureException<E>(Error);
