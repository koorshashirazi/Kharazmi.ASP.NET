...
namespace Kharazmi.AspNetMvc.Core.Managers.Authorization
{
    ...
    public class AuthorizationDependencies : IAuthorizationDependencies
    {
        ...
        /// <param name="handlers">
        ///     The <see cref="IAuthorizationHandler" />s used in creating an
        ///     <see cref="IAuthorizationDependencies" /> object.
        /// </param>
        public static AuthorizationDependencies Create(AuthorizationOptions options,
