    ...
    internal class SingleQueryCommand : QueryCommand
    {
            ...
            bool pagingEnabled, ILinqToLdapLogger log = null, string namingContext = null)
        {
            ...
            if (response.Entries.Count != 1)
                throw new InvalidOperationException(string.Format("Single returned {0} results for '{1}' against '{2}'",
                    response.Entries.Count, SearchRequest.Filter, SearchRequest.DistinguishedName));
