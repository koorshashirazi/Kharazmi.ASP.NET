...
namespace Mvc.Utility.Core.Managers.LinqToLdap.Mapping
{
    ...
    public class DirectoryMapper : IDirectoryMapper
    {
...
#else
        private readonly ConcurrentDictionary<Type, IObjectMapping> _mappings =
        ...
        /// </exception>
        /// <returns></returns>
        public IObjectMapping Map(IClassMap classMap, string namingContext = null,
        ...
        /// <summary>
        ///     Creates or retrieves the <see cref="IObjectMapping" /> from
        ///     <typeparam name="T" />
        ///     .
        /// </summary>
        ...
        /// </exception>
        /// <returns></returns>
        public IObjectMapping Map<T>(string namingContext = null, string objectClass = null,
        ...
        internal static void ValidateObjectClasses(IObjectMapping baseTypeMapping, IObjectMapping subTypeMapping)
        {
            ...
            if (currentMappings.Any(objectMapping => objectMapping.ObjectClasses.OrderBy(x => x)
                ...
                throw new InvalidOperationException(
                    $"All sub types of {baseTypeMapping.Type.Name} must have a unique sequence of objectClasses.");
        }
    }
}