...
{
    internal class CustomPropertyMappingBuilder<T, TProperty> : IPropertyMappingBuilder,
        ICustomPropertyMapper<T, TProperty> where T : class
    {
        ...
        public ICustomPropertyMapper<T, TProperty> ConvertFromDirectoryUsing(
            Func<DirectoryAttribute, TProperty> converter)
        {
        ...
        public bool IsDistinguishedName => false;
        ...
        public IPropertyMapping ToPropertyMapping()
        {
            ...
            return new CustomPropertyMapping<T, TProperty>(arguments, _convertFrom, _convertTo, _convertToFilter,
                _isEqual);
        }
    }
}