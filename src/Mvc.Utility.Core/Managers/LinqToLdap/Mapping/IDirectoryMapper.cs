...
namespace Mvc.Utility.Core.Managers.LinqToLdap.Mapping
{
    ...
    public interface IDirectoryMapper
    {
        ...
        /// </exception>
        /// <returns></returns>
        IObjectMapping Map(IClassMap classMap, string namingContext = null, IEnumerable<string> objectClasses = null,
            bool includeObjectClasses = true, string objectCategory = null, bool includeObjectCategory = true);
        ...
        /// </exception>
        /// <returns></returns>
        IObjectMapping Map<T>(string namingContext = null, string objectClass = null,
