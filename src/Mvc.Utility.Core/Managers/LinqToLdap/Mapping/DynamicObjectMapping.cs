...
namespace Mvc.Utility.Core.Managers.LinqToLdap.Mapping
{
    ...
    {
        public DynamicObjectMapping(string namingContext, IEnumerable<string> objectClasses, string objectCategory,
        ...
        public System.Collections.ObjectModel.ReadOnlyDictionary<string, string> Properties => _properties ?? (_properties
