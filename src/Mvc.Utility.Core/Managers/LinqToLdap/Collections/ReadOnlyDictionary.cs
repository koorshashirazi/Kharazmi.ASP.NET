...
namespace Mvc.Utility.Core.Managers.LinqToLdap.Collections
{
    ...
    public sealed class ReadOnlyDictionary<TKey, TValue> : IDictionary<TKey, TValue>
    {
        ...
        public ICollection<TKey> Keys =>
            _keys ?? (_keys = new ReadOnlyCollection<TKey>(new List<TKey>(_dictionary.Keys)));
        ...
        public ICollection<TValue> Values =>
            _values ?? (_values = new ReadOnlyCollection<TValue>(new List<TValue>(_dictionary.Values)));
