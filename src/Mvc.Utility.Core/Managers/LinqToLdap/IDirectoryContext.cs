...
namespace Mvc.Utility.Core.Managers.LinqToLdap
{
    ...
    public interface IDirectoryContext : IDisposable
    {
        ...
        /// <param name="objectCategory">The object category in the directory for the type</param>
        /// <returns></returns>
        IQueryable<T> Query<T>(T example, string namingContext, string objectClass = null,
        ...
        /// <param name="objectCategory">The object category in the directory for the type</param>
        /// <returns></returns>
        IQueryable<T> Query<T>(T example, SearchScope scope, string namingContext, string objectClass = null,
            IEnumerable<string> objectClasses = null,
        ...
        void AddAttribute(string distinguishedName, string attributeName, object value = null,
        ...
        /// <summary>
        ///     Moves the entry from one container to another without modifying the entry's name and return's the new distinguished
        ///     name.
        /// </summary>
        ...
        /// <exception cref="DirectoryOperationException">Thrown if the operation fails.</exception>
        /// <exception cref="LdapConnection">Thrown if the operation fails.</exception>
        string MoveEntry(string currentDistinguishedName, string newNamingContext, bool? deleteOldRDN = null,
            params DirectoryControl[] controls);

        /// <summary>
        ///     Renames the entry within the same container and return's the new distinguished name. The
        ///     <paramref name="newName" /> should be in the format
        ///     XX=New Name.
        /// </summary>
        /// <param name="currentDistinguishedName">The entry's current distinguished name</param>
        ...
        /// <exception cref="DirectoryOperationException">Thrown if the operation fails.</exception>
        /// <exception cref="LdapConnection">Thrown if the operation fails.</exception>
        string RenameEntry(string currentDistinguishedName, string newName, bool? deleteOldRDN = null,
            params DirectoryControl[] controls);
