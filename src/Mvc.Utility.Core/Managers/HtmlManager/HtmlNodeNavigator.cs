...
namespace Mvc.Utility.Core.Managers.HtmlManager
{
    ...
    public class HtmlNodeNavigator : XPathNavigator
    {
        ...
        internal HtmlNodeNavigator(HtmlDocument doc, HtmlNode currentNode)
        {
            ...
            if (currentNode.OwnerDocument != doc) throw new ArgumentException(HtmlDocument.HtmlExceptionRefNotChild);
        ...
        public override bool MoveToAttribute(string localName, string namespaceURI)
        {
            ...
            InternalTrace("localName=" + localName + ", namespaceURI=" + namespaceURI);
#endif
            var index = CurrentNode.Attributes.GetAttributeIndex(localName);
            if (index == -1)
            {
#if TRACE_NAVIGATOR
                InternalTrace(">false");
