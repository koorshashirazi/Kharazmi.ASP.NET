...
namespace Mvc.Utility.Core.Managers.HtmlManager
{
    ...
    ///     Follows Additional specification found at
    ...
    public class HtmlEntity
    {
        ...
        public static string DeEntitize(string text)
        {
                            ...
                            case ';':
                                ...
                                else
                                {
                                    ...
                                    else
                                    {
                                        // named entity?
                                        int code;
                                        if (!EntityValue.TryGetValue(entity.ToString(), out code))
                                            // nope
                                            sb.Append("&" + entity + ";");
                                        else
                                            // we found one
            ...
            // finish the work
            if (state == ParseState.EntityStart) sb.Append("&" + entity);
        ...
        public static HtmlNode Entitize(HtmlNode node)
        {
            ...
            if (result.HasAttributes) Entitize(result.Attributes);
        ...
        private static void Entitize(HtmlNodeCollection collection)
        {
            ...
            {
                if (node.HasAttributes) Entitize(node.Attributes);
