...
namespace Mvc.Utility.Core.Managers.HtmlManager
{
    ...
    /// </summary>
    [Obsolete("This type should not be used; it is intended for internal use in HTML Manager.")]
    public class Crc32
    {
        #region Static Members

        private static readonly uint[] Crc32Tab = // CRC polynomial 0xedb88320
        {
