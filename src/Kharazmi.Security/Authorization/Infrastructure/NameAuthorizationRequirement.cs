...
namespace Kharazmi.Security.Authorization.Infrastructure
{
    ...
    public class NameAuthorizationRequirement : AuthorizationHandler<NameAuthorizationRequirement>, IAuthorizationRequirement
    {
        ...
        public NameAuthorizationRequirement(string requiredName) { RequiredName = requiredName ?? throw new ArgumentNullException(paramName: nameof(requiredName)); }
        ...
        protected override Task HandleRequirementAsync(AuthorizationHandlerContext context, NameAuthorizationRequirement requirement)
        {
            ...
            if (context.User != null)
            {
                ...
                {
                    if (ContainsRequiredName(identity: identity, requirement: requirement))
                    {
...
#endif
                string.Equals(a: identity.Name, b: requirement.RequiredName, comparisonType: StringComparison.OrdinalIgnoreCase);
    }
}