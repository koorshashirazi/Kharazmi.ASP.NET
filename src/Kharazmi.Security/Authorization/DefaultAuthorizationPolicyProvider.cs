...
namespace Kharazmi.Security.Authorization
{
    ...
    public class DefaultAuthorizationPolicyProvider : IAuthorizationPolicyProvider
    {
        ...
        public DefaultAuthorizationPolicyProvider(AuthorizationOptions options) { _options = options ?? throw new ArgumentNullException(paramName: nameof(options)); }

        /// <summary>
        ///     Gets the default <see cref="AuthorizationPolicy" />
        /// </summary>
        /// <returns>The default <see cref="AuthorizationPolicy" />.</returns>
        public virtual Task<AuthorizationPolicy> GetDefaultPolicyAsync() { return Task.FromResult(result: _options.DefaultPolicy); }
        ...
        public virtual Task<AuthorizationPolicy> GetPolicyAsync(string policyName) { return Task.FromResult(result: _options.GetPolicy(name: policyName)); }
    }
}