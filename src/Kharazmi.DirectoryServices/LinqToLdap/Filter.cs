...
namespace Kharazmi.DirectoryServices.Ldap.LinqToLdap
{
    ...
    public static class Filter
    {
        ...
        /// <param name="shouldCleanValue">Indicates if <paramref name="attributeValue" /> should be cleaned</param>
        /// <returns></returns>
        public static bool Equal<T, TProperty>(T t, Expression<Func<T, TProperty>> property, string attributeValue,
            bool shouldCleanValue)
        {
            return true;
        }
        ...
        /// <param name="shouldCleanValue">Indicates if <paramref name="attributeValue" /> should be cleaned</param>
        /// <returns></returns>
        public static bool Approximately<T, TProperty>(T t, Expression<Func<T, TProperty>> property,
            string attributeValue, bool shouldCleanValue)
        {
            return true;
        }
        ...
        /// <param name="shouldCleanValue">Indicates if <paramref name="attributeValue" /> should be cleaned</param>
        /// <returns></returns>
        public static bool StartsWith<T, TProperty>(T t, Expression<Func<T, TProperty>> property, string attributeValue,
            bool shouldCleanValue)
        {
            return true;
        }
        ...
        /// <param name="shouldCleanValue">Indicates if <paramref name="attributeValue" /> should be cleaned</param>
        /// <returns></returns>
        public static bool EndsWith<T, TProperty>(T t, Expression<Func<T, TProperty>> property, string attributeValue,
            bool shouldCleanValue)
        {
            return true;
        }
        ...
        /// <param name="shouldCleanValue">Indicates if <paramref name="attributeValue" /> should be cleaned</param>
        /// <returns></returns>
        public static bool Like<T, TProperty>(T t, Expression<Func<T, TProperty>> property, string attributeValue,
            bool shouldCleanValue)
        {
            return true;
        }
        ...
        /// <param name="shouldCleanValue">Indicates if <paramref name="attributeValue" /> should be cleaned</param>
        /// <returns></returns>
        public static bool GreaterThanOrEqual<T, TProperty>(T t, Expression<Func<T, TProperty>> property,
            string attributeValue, bool shouldCleanValue)
        {
            return true;
        }
        ...
        /// <param name="shouldCleanValue">Indicates if <paramref name="attributeValue" /> should be cleaned</param>
        /// <returns></returns>
        public static bool GreaterThanOrEqual<T>(T t, string attributeName, string attributeValue,
            bool shouldCleanValue)
        {
            return true;
        }
        ...
        /// <param name="shouldCleanValue">Indicates if <paramref name="attributeValue" /> should be cleaned</param>
        /// <returns></returns>
        public static bool LessThanOrEqual<T, TProperty>(T t, Expression<Func<T, TProperty>> property,
            string attributeValue, bool shouldCleanValue)
        {
            return true;
        }
        ...
        /// <param name="shouldCleanValue">Indicates if <paramref name="attributeValue" /> should be cleaned</param>
        /// <returns></returns>
        public static bool LessThan<T, TProperty>(T t, Expression<Func<T, TProperty>> property, string attributeValue,
            bool shouldCleanValue)
        {
            return true;
        }
        ...
        /// <param name="shouldCleanValue">Indicates if <paramref name="attributeValue" /> should be cleaned</param>
        /// <returns></returns>
        public static bool GreaterThan<T, TProperty>(T t, Expression<Func<T, TProperty>> property,
            string attributeValue, bool shouldCleanValue)
        {
            return true;
        }
        ...
        /// <param name="shouldCleanValue">Indicates if <paramref name="values" /> should be cleaned</param>
        /// <returns></returns>
        public static bool EqualAny<T, TProperty>(T t, Expression<Func<T, TProperty>> property,
            IEnumerable<string> values, bool shouldCleanValue)
        {
            return true;
        }
        ...
        /// <returns></returns>
        public static bool MatchingRule<T>(T t, string attributeName, string ruleOID, string value,
            bool shouldCleanValue)
        {
            return true;
        }
        ...
        /// <param name="shouldCleanValue">Indicates if <paramref name="value" /> should be cleaned</param>
        /// <returns></returns>
        public static bool MatchingRule<T, TProperty>(T t, Expression<Func<T, TProperty>> property, string ruleOID,
            string value, bool shouldCleanValue)
        {
            return true;
        }
    }
