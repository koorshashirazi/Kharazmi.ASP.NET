...
{
    internal class PooledLdapConnectionFactory : ConnectionFactoryBase, IPooledConnectionFactoryConfiguration,
        IPooledLdapConnectionFactory, IDisposable
    {
        ...
        IPooledConnectionFactoryConfiguration IPooledConnectionFactoryConfiguration.AuthenticateAs(
        ...
        IPooledConnectionFactoryConfiguration IPooledConnectionFactoryConfiguration.ConnectionIdleTimeIs(
            double idleTime)
        {
        ...
        public void Reinitialize()
        {
            ...
            lock (_connectionLockObject)
            {
                ...
                foreach (var availableConnection in _availableConnections) availableConnection.Key.Dispose();
        ...
        {
            if (Logger != null && Logger.TraceEnabled) Logger.Trace("Initializing Connection Pool.");
            for (var i = 0; i < _minPoolSize; i++) _availableConnections.Add(BuildConnection(), DateTime.Now);
        ...
        {
            var amountToScavenge = _minPoolSize == 0
