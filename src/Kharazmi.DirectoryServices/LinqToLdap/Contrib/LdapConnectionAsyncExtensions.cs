...
namespace Kharazmi.DirectoryServices.Ldap.LinqToLdap.Contrib
{
    ...
    public static class LdapConnectionAsyncExtensions
    {
        ...
        ///     Executes
        ///     <see
        ///         cref="LdapConnectionExtensions.Add(LdapConnection,IDirectoryAttributes,ILinqToLdapLogger,DirectoryControl[],IEnumerable{IAddEventListener})" />
        ///     within a <see cref="Task" />.
        /// </summary>
        ...
        public static Task AddAsync(this LdapConnection connection, IDirectoryAttributes entry,
            ILinqToLdapLogger log = null,
        ...
        /// <exception cref="DirectoryOperationException">Thrown if the add was not successful.</exception>
        /// <exception cref="LdapException">Thrown if the operation fails.</exception>
        public static Task<IDirectoryAttributes> AddAndGetAsync(this LdapConnection connection,
            IDirectoryAttributes entry, ILinqToLdapLogger log = null, DirectoryControl[] controls = null,
            IEnumerable<IPreAddEventListener> listeners = null)
        {
        ...
        /// <exception cref="LdapException">Thrown if the operation fails.</exception>
        public static Task DeleteAsync(this LdapConnection connection, string distinguishedName,
            ILinqToLdapLogger log = null, DirectoryControl[] controls = null,
            IEnumerable<IPreDeleteEventListener> listeners = null)
        {
        ...
        /// <exception cref="DirectoryOperationException">Thrown if the operation fails</exception>
        /// <exception cref="LdapException">Thrown if the operation fails</exception>
        public static Task UpdateAsync(this LdapConnection connection, IDirectoryAttributes entry,
            ILinqToLdapLogger log = null, DirectoryControl[] controls = null,
            IEnumerable<IPreUpdateEventListener> listeners = null)
        {
        ...
        /// <exception cref="DirectoryOperationException">Thrown if the operation fails</exception>
        /// <exception cref="LdapException">Thrown if the operation fails</exception>
        public static Task<IDirectoryAttributes> UpdateAndGetAsync(this LdapConnection connection,
            IDirectoryAttributes entry, ILinqToLdapLogger log = null, DirectoryControl[] controls = null,
            IEnumerable<IPreUpdateEventListener> listeners = null)
        {
        ...
        /// </param>
        /// <returns></returns>
        public static Task<IDirectoryAttributes> ListServerAttributesAsync(this LdapConnection connection,
        ...
        /// <returns></returns>
        public static Task<IDirectoryAttributes> GetByDNAsync(this LdapConnection connection, string distinguishedName,
        ...
        public static Task<string> MoveEntryAsync(this LdapConnection connection, string currentDistinguishedName,
            string newNamingContext, ILinqToLdapLogger log = null, params DirectoryControl[] controls)
        {
        ...
        /// <exception cref="DirectoryOperationException">Thrown if the operation fails.</exception>
        /// <exception cref="LdapConnection">Thrown if the operation fails.</exception>
        public static Task<string> RenameEntryAsync(this LdapConnection connection, string currentDistinguishedName,
            string newName, ILinqToLdapLogger log = null, params DirectoryControl[] controls)
        {
        ...
        /// </exception>
        /// <returns></returns>
        public static Task<IList<TValue>> RetrieveRangesAsync<TValue>(this LdapConnection connection,
            string distinguishedName, string attributeName, int start = 0, ILinqToLdapLogger log = null)
        {
            return
