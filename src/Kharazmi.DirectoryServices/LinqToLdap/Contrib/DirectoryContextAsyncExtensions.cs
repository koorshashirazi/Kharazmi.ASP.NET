...
namespace Kharazmi.DirectoryServices.Ldap.LinqToLdap.Contrib
{
    /// <summary>
    ...
    public static class DirectoryContextAsyncExtensions
    {
        ...
        /// <returns></returns>
        public static Task<IDirectoryAttributes> GetByDNAsync(this IDirectoryContext context, string distinguishedName,
        ...
        /// <param name="distinguishedName">The distinguished name for the entry.</param>
        /// <param name="controls">Any <see cref="DirectoryControl" />s to be sent with the request</param>
        public static Task<T> AddAndGetAsync<T>(this IDirectoryContext context, T entry,
        ...
        /// <param name="entry">The attributes for the entry</param>
        /// <param name="controls">Any <see cref="DirectoryControl" />s to be sent with the request</param>
        public static Task<IDirectoryAttributes> AddAndGetAsync(this IDirectoryContext context,
            IDirectoryAttributes entry,
            DirectoryControl[] controls)
        {
        ...
        public static Task Delete(this IDirectoryContext context, string distinguishedName,
        ...
        /// <exception cref="DirectoryOperationException">Thrown if the operation fails</exception>
        /// <exception cref="LdapException">Thrown if the operation fails</exception>
        public static Task<IDirectoryAttributes> UpdateAndGetAsync(this IDirectoryContext context,
            IDirectoryAttributes entry)
        {
        ...
        /// <summary>
        ///     Executes <see cref="DirectoryContext.UpdateAndGet(IDirectoryAttributes,DirectoryControl[])" /> within a
        ///     <see cref="Task" />.
        /// </summary>
        /// <param name="context">The context.</param>
        /// <param name="entry">The attributes for the entry.</param>
        ...
        /// <summary>
        ///     Executes <see cref="DirectoryContext.Update(IDirectoryAttributes,DirectoryControl[])" /> within a
        ///     <see cref="Task" />.
        /// </summary>
        /// <param name="context">The context.</param>
        /// <param name="entry">The attributes for the entry.</param>
        ...
        /// <exception cref="DirectoryOperationException">Thrown if the operation fails.</exception>
        /// <exception cref="LdapException">Thrown if the operation fails.</exception>
        public static Task DeleteAsync(this IDirectoryContext context, string distinguishedName,
            params DirectoryControl[] controls)
        {
            return Task.Factory.StartNew(() => context.Delete(distinguishedName, controls));
        }
        ...
        /// </summary>
        /// <returns></returns>
        public static Task<IDirectoryAttributes> ListServerAttributesAsync(this IDirectoryContext context,
            params string[] attributes)
        {
        ...
        public static Task AddAttributeAsync(this IDirectoryContext context, string distinguishedName,
            string attributeName, object value = null,
        ...
        /// <param name="controls">Any <see cref="DirectoryControl" />s to be sent with the request</param>
        /// <exception cref="ArgumentNullException">
        ///     Thrown if <paramref name="distinguishedName" /> or
        ///     <paramref name="attributeName" /> is null, empty or white space.
        /// </exception>
        /// <exception cref="DirectoryOperationException">Thrown if the operation fails.</exception>
        /// <exception cref="LdapConnection">Thrown if the operation fails.</exception>
        public static Task DeleteAttributeAsync(this IDirectoryContext context, string distinguishedName,
        ...
        /// <exception cref="DirectoryOperationException">Thrown if the operation fails.</exception>
        /// <exception cref="LdapConnection">Thrown if the operation fails.</exception>
        public static Task<string> MoveEntryAsync(this IDirectoryContext context, string currentDistinguishedName,
            string newNamingContext,
            bool? deleteOldRDN = null, params DirectoryControl[] controls)
        {
            return Task.Factory.StartNew(() =>
                context.MoveEntry(currentDistinguishedName, newNamingContext, deleteOldRDN, controls));
        }
        ...
        /// <exception cref="DirectoryOperationException">Thrown if the operation fails.</exception>
        /// <exception cref="LdapConnection">Thrown if the operation fails.</exception>
        public static Task<string> RenameEntryAsync(this IDirectoryContext context, string currentDistinguishedName,
            string newName,
            bool? deleteOldRDN = null, params DirectoryControl[] controls)
        {
            return Task.Factory.StartNew(() =>
                context.RenameEntry(currentDistinguishedName, newName, deleteOldRDN, controls));
        }
        ...
        /// </exception>
        /// <returns></returns>
        public static Task<IList<TValue>> RetrieveRangesAsync<TValue>(this IDirectoryContext context,
