...
using Kharazmi.DirectoryServices.Ldap.LinqToLdap.TestSupport;
...
namespace Kharazmi.DirectoryServices.Ldap.LinqToLdap
{
    ...
    public static class QueryableExtensions
    {
        ...
        /// </exception>
        /// <returns></returns>
        public static IQueryable<TSource> WithControls<TSource>(this IQueryable<TSource> source,
            IEnumerable<DirectoryControl> controls)
        {
            ...
            if (!controls.Any())
                throw new FilterException("Must specify at least one control when using WithControls.");
        ...
        /// </exception>
        /// <returns></returns>
        public static IQueryable<TSource> ScopedToAttribute<TSource>(this IQueryable<TSource> source,
        ...
        /// <returns></returns>
        public static IEnumerable<KeyValuePair<string, IEnumerable<KeyValuePair<string, object>>>>
            ListAttributes<TSource>(
                this IQueryable<TSource> source, params string[] attributes)
        {
            return source.Provider
                .Execute<IEnumerable<KeyValuePair<string, IEnumerable<KeyValuePair<string, object>>>>>(
                    Expression.Call(null,
                        ((MethodInfo) MethodBase.GetCurrentMethod())
                        .MakeGenericMethod(typeof(TSource)),
            ...
            string filter)
        {
            ...
            return
                source.Provider.Execute<ILdapPage<TSource>>(
                    Expression.Call(null,
                        ((MethodInfo) MethodBase.GetCurrentMethod())
                        .MakeGenericMethod(typeof(TSource)), source.Expression, Expression.Constant(pageSize),
                        Expression.Constant(nextPage), Expression.Constant(filter)));
        }
        ...
        public static IQueryable<IDirectoryAttributes> Select(this IQueryable<IDirectoryAttributes> source,
        ...
        /// <param name="source">
        ///     The <see cref="IQueryable{T}" /> from which to create a
        ///     <see cref="System.Collections.Generic.List{T}" />.
        /// </param>
        /// <returns>
        ///     A <see cref="System.Collections.Generic.List{T}" /> that contains elements from the input sequence.
        ///     If this method is used with LINQ to LDAP then an <see cref="LdapPage{T}" /> may be created if
        ///     <see cref="WithControls{T}" /> is used with a
        ...
        public static List<TSource> ToList<TSource>(this IQueryable<TSource> source)
        {
            if (source is DirectoryQuery<TSource> || source is MockQuery<TSource>)
                return source.Provider.Execute<List<TSource>>(
                    Expression.Call(null,
                        ((MethodInfo) MethodBase.GetCurrentMethod())
                        .MakeGenericMethod(typeof(TSource)), source.Expression));
        ...
        /// <typeparam name="TSource">The type of the elements of <paramref name="source" />.</typeparam>
        /// <param name="source">The query.</param>
        /// <exception cref="DirectoryOperationException">
        ///     Potentially thrown if the result set exceeds the size defined by the
        ///     server.
        /// </exception>
        /// <returns></returns>
