...
namespace Kharazmi.DirectoryServices.Ldap.LinqToLdap
{
    internal abstract class QueryProvider : IQueryProvider
    {
        ...
        public IQueryable CreateQuery(Expression expression)
        {
            ...
            return (IQueryable) Activator.CreateInstance(typeof(DirectoryQuery<>).MakeGenericType(elementType), this,
                expression);
        }
        ...
        /// </summary>
        /// <returns>
        ///     An <see cref="T:System.Linq.IQueryable`1" /> that can evaluate the query represented by the specified expression
        ///     tree.
        /// </returns>
        /// <param name="expression">
        ///     An expression tree that represents a LINQ query.
