...
using Kharazmi.DirectoryServices.Ldap.LinqToLdap.EventListeners;
...
namespace Kharazmi.DirectoryServices.Ldap.LinqToLdap
{
    ...
    public class DirectoryContext : IDirectoryContext
    {
        ...
        /// <param name="disposeOfConnection">
        ///     Indicates if the context should dispose of the connection when
        ...
        public DirectoryContext(LdapConnection connection, bool disposeOfConnection = false,
            ILdapConfiguration configuration = null)
        {
            if (connection == null) throw new ArgumentNullException("connection");

            if (configuration == null) configuration = LdapConfiguration.Configuration ?? new LdapConfiguration();
        ...
        ///     The underlying connection will be disposed of when this instance is disposed if the
        ///     <see cref="LdapConfiguration" /> doeas not
        ///     have a configured <see cref="ILdapConnectionFactory" />.  Otherwise
        ///     <see cref="ILdapConnectionFactory.ReleaseConnection" /> will be called.
        /// </summary>
        ...
        public DirectoryContext(ILdapConfiguration configuration)
        {
            if (configuration == null || configuration.ConnectionFactory == null)
                throw new MappingException(
                    "configuration cannot be null and must be associated with a connection factory.");
        ...
        public DirectoryContext()
        {
            if (LdapConfiguration.Configuration == null || LdapConfiguration.Configuration.ConnectionFactory == null)
                throw new MappingException(
                    "A static configuration and connection factory must be provided. See LdapConfiguration.UseStaticStorage()");
        ...
        public TextWriter Log
        {
            set
            {
                if (value != null) Logger = new SimpleTextLogger(value);
            }
        }
        ...
        /// <summary>
        ///     Retrieves the mapped class from the directory using the distinguished name.  <see cref="SearchScope.Base" /> is
        ///     used.
        /// </summary>
        /// <param name="distinguishedName">The distinguished name to look for.</param>
        ...
        public T GetByDN<T>(string distinguishedName) where T : class
        {
            try
            {
                ...
                foreach (var property in attributes) request.Attributes.Add(property);
            ...
            catch (Exception ex)
            {
                if (Logger != null)
                    Logger.Error(ex,
                        string.Format("An error occurred while trying to retrieve '{0}'.", distinguishedName));
        ...
        /// <summary>
        ///     Adds the entry to the directory and returns the newly saved entry from the directory. If the
        ///     <paramref name="distinguishedName" /> is
        ...
        ///     Thrown if distinguished name is null and there is no mapped distinguished name
        ///     property.
        /// </exception>
        /// <exception cref="MappingException">
        ...
        /// <exception cref="ObjectDisposedException">Thrown if this instance has been disposed.</exception>
        public T AddAndGet<T>(T entry, string distinguishedName = null, DirectoryControl[] controls = null)
            where T : class
        {
        ...
        public void Delete(string distinguishedName, params DirectoryControl[] controls)
        {
            ...
            _connection.Delete(distinguishedName, Logger, controls,
                _configuration.GetListeners<IDeleteEventListener>());
        }
        ...
        ///     Thrown if <paramref name="entry" /> is <see cref="DirectoryObjectBase" />
        ///     but the entry is not tracking changes.
        /// </exception>
        ...
        /// <exception cref="ObjectDisposedException">Thrown if this instance has been disposed.</exception>
        public void Update<T>(T entry, string distinguishedName = null, params DirectoryControl[] controls)
            where T : class
        {
        ...
        /// <summary>
        ///     Updates the entry in the directory and returns the updated version from the directory. If the
        ///     <paramref name="distinguishedName" /> is
        ///     null then a mapped distinguished name property is used.
        /// </summary>
        /// <param name="entry">The entry to update</param>
        ...
        /// <exception cref="LdapException">Thrown if the operation is not successful</exception>
        /// <exception cref="ObjectDisposedException">Thrown if this instance has been disposed.</exception>
        public T UpdateAndGet<T>(T entry, string distinguishedName = null, params DirectoryControl[] controls)
            where T : class
        {
        ...
        {
            if (_disposed) throw new ObjectDisposedException(GetType().FullName);
            return _connection.UpdateAndGet(entry, Logger,
                listeners: _configuration.GetListeners<IUpdateEventListener>());
        }
        ...
        {
            if (_disposed) throw new ObjectDisposedException(GetType().FullName);
            return _connection.UpdateAndGet(entry, Logger, controls,
                _configuration.GetListeners<IUpdateEventListener>());
        }
        ...
        /// <exception cref="ObjectDisposedException">Thrown if this instance has been disposed.</exception>
        public void AddAttribute(string distinguishedName, string attributeName, object value = null,
        ...
        public void DeleteAttribute(string distinguishedName, string attributeName, params DirectoryControl[] controls)
        {
            ...
            attributes.AddModification(
                ExtensionMethods.ToDirectoryModification(null, attributeName, DirectoryAttributeOperation.Delete));
        ...
        ///     Maps to <see cref="P:System.DirectoryServices.Protocols.ModifyDNRequest.DeleteOldRdn" />.
        ///     Defaults to null to use default behavior from
        ///     <see cref="P:System.DirectoryServices.Protocols.ModifyDNRequest.DeleteOldRdn" />.
        /// </param>
        /// <param name="controls">Any <see cref="DirectoryControl" />s to be sent with the request</param>
        /// <exception cref="ArgumentException">
        ...
        /// </exception>
        /// <exception cref="ArgumentNullException">
        ///     Thrown if <paramref name="currentDistinguishedName" />
        ///     or <paramref name="newNamingContext" /> are null, empty or white space.
        /// </exception>
        /// <exception cref="DirectoryOperationException">Thrown if the operation fails.</exception>
        /// <exception cref="LdapConnection">Thrown if the operation fails.</exception>
        /// <exception cref="ObjectDisposedException">Thrown if this instance has been disposed.</exception>
        public string MoveEntry(string currentDistinguishedName, string newNamingContext, bool? deleteOldRDN = null,
        ...
        /// <exception cref="LdapConnection">Thrown if the operation fails.</exception>
        /// <exception cref="ObjectDisposedException">Thrown if this instance has been disposed.</exception>
        public string RenameEntry(string currentDistinguishedName, string newName, bool? deleteOldRDN = null,
            params DirectoryControl[] controls)
        {
            if (_disposed) throw new ObjectDisposedException(GetType().FullName);
        ...
        /// <summary>
        ///     Uses range retrieval to get all values for <paramref name="attributeName" /> on
        ///     <paramref name="distinguishedName" />.
        /// </summary>
        /// <typeparam name="TValue">
        ///     The type of the attribute.  Must be <see cref="string" /> or <see cref="Array" /> of
        ///     <see cref="byte" />.
        /// </typeparam>
        /// <param name="distinguishedName">The distinguished name of the entry.</param>
        ...
        private string AddEntry<T>(T entry, string distinguishedName = null, DirectoryControl[] controls = null)
            where T : class
        {
            try
            {
                ...
                if (objectMapping.ObjectClasses != null && objectMapping.ObjectClasses.Any())
                    attributes.Add(new DirectoryAttribute("objectClass",
                        objectMapping.ObjectClasses.Select(oc => (object) oc).ToArray()));
                else
                    throw new MappingException(
                ...
                if (controls != null) request.Controls.AddRange(controls);
                ...
                foreach (var da in directoryAttributes.Union(attributes)) request.Attributes.Add(da);
                ...
                var postArgs =
                    new ListenerPostArgs<object, AddRequest, AddResponse>(entry, request, response, _connection);
            ...
            {
                if (Logger != null)
                    Logger.Error(ex, string.Format("An error occurred while trying to add '{0}'.", distinguishedName));
                throw;
            }
            ...
            where T : class
        {
            try
            {
                ...
                if (catchAll != null) modifications.AddRange(catchAll.GetChangedAttributes());

                if (modifications.Count == 0)
                {
                    if (Logger != null && Logger.TraceEnabled)
                        Logger.Trace(string.Format("No changes found for {0}.", distinguishedName));
                ...
                var postArgs =
                    new ListenerPostArgs<object, ModifyRequest, ModifyResponse>(entry, request, response, _connection);
            ...
            catch (Exception ex)
            {
                if (Logger != null)
                    Logger.Error(ex,
                        string.Format("An error occurred while trying to update '{0}'.", distinguishedName));
                throw;
            }
        ...
        internal static string GetDistinguishedName<T>(string distinguishedName, IObjectMapping objectMapping, T entry)
        {
            if (distinguishedName.IsNullOrEmpty())
            {
                ...
                if (distinguishedName.IsNullOrEmpty())
                    throw new ArgumentException("The distinguished name cannot be null or empty.");
            }
        ...
        /// <exception cref="ObjectDisposedException">Thrown if this instance has been disposed.</exception>
        /// <returns></returns>
        public IQueryable<T> Query<T>(SearchScope scope = SearchScope.Subtree, string namingContext = null)
            where T : class
        {
            return PrivateQuery<T>(scope, namingContext);
        }

        private IQueryable<T> PrivateQuery<T>(SearchScope scope, string namingContext, string objectClass = null,
            IEnumerable<string> objectClasses = null, string objectCategory = null) where T : class
        {
            try
            {
                if (_disposed) throw new ObjectDisposedException(GetType().FullName);
        ...
        /// <exception cref="ObjectDisposedException">Thrown if this instance has been disposed.</exception>
        /// <returns></returns>
        public IQueryable<T> Query<T>(T example, string namingContext, string objectClass = null,
            IEnumerable<string> objectClasses = null, string objectCategory = null) where T : class
        {
        ...
        /// <exception cref="ObjectDisposedException">Thrown if this instance has been disposed.</exception>
        /// <returns></returns>
        public IQueryable<T> Query<T>(T example, SearchScope scope, string namingContext, string objectClass = null,
            IEnumerable<string> objectClasses = null, string objectCategory = null) where T : class
        {
        ...
        /// <exception cref="ObjectDisposedException">Thrown if this instance has been disposed.</exception>
        /// <returns></returns>
        public IQueryable<IDirectoryAttributes> Query(string namingContext, SearchScope scope = SearchScope.Subtree,
