namespace Kharazmi.Net.Http.OAuth2
{
    ...
    public sealed class JwtClaimModelTypes
    {
        private JwtClaimModelTypes(string value)
        {
            Value = value;
        }
        ...
        public static JwtClaimModelTypes Subject => new JwtClaimModelTypes("sub");

        //
        // Summary:
        //     The iat (issued at) claim identifies the time at which the JWT was issued, ,
        //     specified as the number of seconds from 1970-01-01T0:0:0Z
        public static JwtClaimModelTypes IssuedAt => new JwtClaimModelTypes("iat");
        ...
        public static JwtClaimModelTypes AuthenticationMethod => new JwtClaimModelTypes("amr");
        ...
        //     to the RP.
        public static JwtClaimModelTypes SessionId => new JwtClaimModelTypes("sid");
        ...
        public static JwtClaimModelTypes AuthenticationContextClassReference => new JwtClaimModelTypes("acr");
        ...
        public static JwtClaimModelTypes AuthenticationTime => new JwtClaimModelTypes("auth_time");
        ...
        public static JwtClaimModelTypes AuthorizedParty => new JwtClaimModelTypes("azp");
        ...
        public static JwtClaimModelTypes AccessTokenHash => new JwtClaimModelTypes("at_hash");
        ...
        public static JwtClaimModelTypes AuthorizationCodeHash => new JwtClaimModelTypes("c_hash");
        ...
        //     until the date/time.
        public static JwtClaimModelTypes UpdatedAt => new JwtClaimModelTypes("updated_at");
        ...
        //     string.
        public static JwtClaimModelTypes Nonce => new JwtClaimModelTypes("nonce");
        ...
        public static JwtClaimModelTypes Events => new JwtClaimModelTypes("events");

        //
        // Summary:
        //     OAuth 2.0 Client Identifier valid at the Authorization Server.
        public static JwtClaimModelTypes ClientId => new JwtClaimModelTypes("client_id");
        ...
        //     SHOULD be ignored.
        public static JwtClaimModelTypes Scope => new JwtClaimModelTypes("scope");
        ...
        public static JwtClaimModelTypes Actor => new JwtClaimModelTypes("act");
        ...
        public static JwtClaimModelTypes MayAct => new JwtClaimModelTypes("may_act");

        //
        // Summary:
        //     an identifier
        public static JwtClaimModelTypes Id => new JwtClaimModelTypes("id");

        //
        // Summary:
        //     The identity provider
        public static JwtClaimModelTypes IdentityProvider => new JwtClaimModelTypes("idp");

        //
        // Summary:
        //     The role
        public static JwtClaimModelTypes Role => new JwtClaimModelTypes("role");
        ...
        public static JwtClaimModelTypes JwtId => new JwtClaimModelTypes("jti");
        ...
        public static JwtClaimModelTypes Expiration => new JwtClaimModelTypes("exp");
        ...
        public static JwtClaimModelTypes NotBefore => new JwtClaimModelTypes("nbf");
        ...
        public static JwtClaimModelTypes Issuer => new JwtClaimModelTypes("iss");
        ...
        public static JwtClaimModelTypes Name => new JwtClaimModelTypes("name");
        ...
        //     by space characters.
        public static JwtClaimModelTypes GivenName => new JwtClaimModelTypes("given_name");
        ...
        public static JwtClaimModelTypes FamilyName => new JwtClaimModelTypes("family_name");
        ...
        public static JwtClaimModelTypes MiddleName => new JwtClaimModelTypes("middle_name");
        ...
        //     value of Michael.
        public static JwtClaimModelTypes NickName => new JwtClaimModelTypes("nickname");
        ...
        public static JwtClaimModelTypes PreferredUserName => new JwtClaimModelTypes("preferred_username");

        //
        // Summary:
        //     URL of the End-User's profile page. The contents of this Web page SHOULD be about
        //     the End-User.
        public static JwtClaimModelTypes Profile => new JwtClaimModelTypes("profile");
        ...
        public static JwtClaimModelTypes Picture => new JwtClaimModelTypes("picture");
        ...
        //     with.
        public static JwtClaimModelTypes WebSite => new JwtClaimModelTypes("website");
        ...
        public static JwtClaimModelTypes Email => new JwtClaimModelTypes("email");
        ...
        public static JwtClaimModelTypes EmailVerified => new JwtClaimModelTypes("email_verified");

        //
        // Summary:
        //     End-User's gender. Values defined by this specification are "female" and "male".
        //     Other values MAY be used when neither of the defined values are applicable.
        public static JwtClaimModelTypes Gender => new JwtClaimModelTypes("gender");
        ...
        //     the dates.
        public static JwtClaimModelTypes BirthDate => new JwtClaimModelTypes("birthdate");
        ...
        public static JwtClaimModelTypes ZoneInfo => new JwtClaimModelTypes("zoneinfo");
        ...
        public static JwtClaimModelTypes Locale => new JwtClaimModelTypes("locale");
        ...
        public static JwtClaimModelTypes PhoneNumber => new JwtClaimModelTypes("phone_number");
        ...
        public static JwtClaimModelTypes PhoneNumberVerified => new JwtClaimModelTypes("phone_number_verified");
        ...
        public static JwtClaimModelTypes Address => new JwtClaimModelTypes("address");
        ...
        public static JwtClaimModelTypes Audience => new JwtClaimModelTypes("aud");

        //
        // Summary:
        //     The reference token identifier
        public static JwtClaimModelTypes ReferenceTokenId => new JwtClaimModelTypes("reference_token_id");

        //
        // Summary:
        //     The confirmation
        public static JwtClaimModelTypes Confirmation => new JwtClaimModelTypes("cnf");
    }
}